            	...
            	@if (in_array(Auth::user()->role , ['audit','admin']))
					<li class="dropdown">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
							<i class="fa fa-check-square" aria-hidden="true"></i> Transacciones
							<span class="caret"></span>
						</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="{{ url('/rutaaqui') }}"><i class="fa fa-btn fa-key"></i> Reservas de Salas</a></li>
							<li><a href="{{ url('/rutaaqui') }}"><i class="fa fa-btn fa-sign-out"></i> Reservas de Equipos</a></li>
						</ul>
					</li>
						</ul>
					</li>
